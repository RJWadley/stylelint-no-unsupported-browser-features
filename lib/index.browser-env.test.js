 ...
 *
 * This specific test suite does not pass a "browsers" configuration setting,
 * Instead it relies on browserslist resolving the supported browsers. We're
 * setting the environment vars BROWSERSLIST_DISABLE_CACHE and
 * BROWSERSLIST='IE 8' in the package.json scripts so that the browser will
 * resolve to IE 8.
 *
